            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user-password.update') }}">
                        ...
                        {{-- @dd(session('status')) boye kullanım var islem sonrası donen mesajı gosterir--}}
                        ...
                        <div class="form-group row">
                            <label for="current_password" class="col-md-4 col-form-label text-md-right">{{ __('Curren Password') }}</label>
